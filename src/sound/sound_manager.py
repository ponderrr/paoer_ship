...
class SoundManager:
    ...
    def _load_music_playlist(self):
        ...
        # Shuffle playlist if shuffle mode is on
    ...
    def play_next_track(self):
        ...
        try:
            ...
            # Reshuffle if we've played through the whole playlist
            if self.current_track_index == 0 and self.shuffle_mode:
                random.shuffle(self.playlist)
    ...
    def toggle_shuffle(self):
        ...
        if self.shuffle_mode and self.playlist:
            ...
            remaining_tracks = self.playlist[self.current_track_index:]
            random.shuffle(remaining_tracks)
            self.playlist[self.current_track_index:] = remaining_tracks
