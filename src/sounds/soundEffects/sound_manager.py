...
class SoundManager:
    def __init__(self):
        ...
        self.sounds = {
            "hit": pygame.mixer.Sound("src/sounds/soundEffects/large-underwater-explosion-190270.mp3"),
        ...
        # Background music
        pygame.mixer.music.load("src/sounds/soundEffects/ultimatum-120bpm-orchestra-loop-325053.mp3")
